...
class LearnsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create learn" do
    assert_difference('Learn.count') do
      post learns_url, params: { learn: { keyword: @learn.keyword, message: @learn.message } }
    end
  ...
  test "should update learn" do
    patch learn_url(@learn), params: { learn: { keyword: @learn.keyword, message: @learn.message } }
